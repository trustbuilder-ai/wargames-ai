 ...
 */
export const submitMessageToChallengeChallengesChallengeIdSubmitMessagePost = <ThrowOnError extends boolean = false>(options: Options<SubmitMessageToChallengeChallengesChallengeIdSubmitMessagePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SubmitMessageToChallengeChallengesChallengeIdSubmitMessagePostResponses, SubmitMessageToChallengeChallengesChallengeIdSubmitMessagePostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getSampleMessagesSampleMessagesGet = <ThrowOnError extends boolean = false>(options?: Options<GetSampleMessagesSampleMessagesGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetSampleMessagesSampleMessagesGetResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
