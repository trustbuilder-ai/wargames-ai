    ...
    <div className="page-content">
      ...
      <div className="lorem-content">
        <p>
          ...
          malesuada. Curabitur aliquet quam id dui posuere blandit.
        </p>
        <p>
        ...
        <p>
          Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Proin eget tortor 
          risus. Donec rutrum congue leo eget malesuada. Pellentesque in ipsum id orci porta 
          dapibus.
        </p>
      </div>
    </div>
