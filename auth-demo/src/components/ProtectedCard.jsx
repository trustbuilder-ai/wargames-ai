      ...
      <div className={`protected-card unauthenticated ${className}`}>
        <div className="lock-icon">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M7 9V7a5 5 0 0110 0v2h1a2 2 0 012 2v8a2 2 0 01-2 2H6a2 2 0 01-2-2v-8a2 2 0 012-2h1zm2-2a3 3 0 016 0v2H9V7z" fill="currentColor"/>
          </svg>
        </div>
